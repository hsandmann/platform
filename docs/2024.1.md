...
=== "[planning](#planning)"
    ...
    |:-:|:-|-|-|-|
    | aula 1 <br>07.fev | Apresentação <br> Discusão monólito vs microsserviços | | | |
    | aula 2 <br>09.fev | Mitigação de dependências <br> Simplificação de sistemas <br> Empacotamento de serviços | Conceitos de microsserviços <br> Conceito de Domain Driven Design <br> Maven e Gradle | | |
    | aula 3 <br>16.fev | Implementação de microsserviços | Frameworks de microsserviços (Spring Boot)<br> Conceito de design patterns <br> Docker | | |
    | aula 4 <br>21.fev | Persistência de objetos | Object-relational Mapping ORM <br> Design pattern master-detail | | |
    | aula 5 <br>23.fev | | Design pattern Gateway <br> Design pattern Discovery | | |
    | aula 6 <br>28.fev | | Design pattern Config <br> Intercomunicação entre microsserviços | | |
    | aula 7 <br>01.mar | | Conceitos de segurança: autenticação e autorização <br> Tipos de autenticação | | |
    | aula 8 <br>06.mar | |  | | |
    | aula 9 <br>08.mar | | | | |
    | aula 10 <br>13.mar | | | | |
    | aula 11 <br>15.mar | | | | |
